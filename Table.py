...
class Table:
    ...
    def generate_order(self, waiter_id):
        ...
        self.order = Order(order_id=order_id, table_id=self.table_id, waiter_id=waiter_id,
                           items=item_ids, priority=priority, max_wait=max_wait, pick_up_time=int(time.time()))
